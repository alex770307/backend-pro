package homework_01.appStructureVar2.front.menu;
...
import homework_01.appStructureVar2.back.service.AddTaskService;
import homework_01.appStructureVar2.back.service.DeleteTaskService;
import homework_01.appStructureVar2.back.service.FindTaskService;
import homework_01.appStructureVar2.back.service.UpdateTaskService;
...
public class UserMenu {
    ...
    public UserMenu(AddTaskService addTaskService, FindTaskService findTaskService,
                    DeleteTaskService deleteTaskService,
                    UpdateTaskService updateTaskService, UserInput userInput) {
    ...
    private void updateTaskById() {
        System.out.println("Изменение задачи по ID");
        Integer taskId = userInput.userInt("Введите ID задачи: ");
        ...
        ResponseDto<Task> response = updateTaskService.updateTaskById(taskId,taskName,taskDescription);
